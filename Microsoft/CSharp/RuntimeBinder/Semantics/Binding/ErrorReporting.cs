...
namespace Microsoft.CSharp.RuntimeBinder.Semantics
{
    ...
    {
        private static readonly Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode[] s_ReadOnlyLocalErrors =
        {
            Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_RefReadonlyLocal,
            Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_AssgReadonlyLocal,
        };
        ...
        private RuntimeBinderException ReportLocalError(LocalVariableSymbol local, CheckLvalueKind kind, bool isNested)
        {
            ...
            Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode err = s_ReadOnlyLocalErrors[index];

            return ErrorContext.Error(err, local.name);
        }

        private static readonly Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode[] s_ReadOnlyErrors =
        {
            Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_RefReadonly,
            Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_AssgReadonly,
            Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_RefReadonlyStatic,
            Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_AssgReadonlyStatic,
            Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_RefReadonly2,
            Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_AssgReadonly2,
            Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_RefReadonlyStatic2,
            Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_AssgReadonlyStatic2
        };
        ...
        private RuntimeBinderException ReportReadOnlyError(ExprField field, CheckLvalueKind kind, bool isNested)
        {
            ...
            Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode err = s_ReadOnlyErrors[index];
            ...
            while (true)
            {
                ...
                if (pObject != null && pObject.Type.isStructOrEnum())
                {
                    if (pObject is IExprWithArgs withArgs)
                    {
                        ...
                        throw ErrorContext.Error(Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_ReturnNotLValue, withArgs.GetSymWithType());
                    }
                    if (pObject is ExprCast)
                    {
                        ...
                        // ErrorContext.Error(pObject.GetTree(), Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_UnboxNotLValue);
                        //
