    ...
    internal sealed partial class ExpressionBinder
    {
        ...
        */
        ...
        private RuntimeBinderException AmbiguousOperatorError(ExpressionKind ek, Expr op1, Expr op2)
        {
            ...
            return op2 != null
                ? GetErrorContext().Error(Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_AmbigBinaryOps, strOp, op1.Type, op2.Type)
                : GetErrorContext().Error(Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_AmbigUnaryOp, strOp, op1.Type);
        }
        ...
        private Expr BindUserBoolOp(ExpressionKind kind, ExprCall pCall)
        {
            ...
            {
                throw GetErrorContext().Error(Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_BadBoolOp, pCall.MethWithInst);
            }
            ...
            {
                throw GetErrorContext().Error(Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_MustHaveOpTF, typeRet);
            }
        ...
        private ExprCall BindUDBinop(ExpressionKind ek, Expr arg1, Expr arg2, bool fDontLift, out MethPropWithInst ppmpwi)
        {
            ...
            if (pmethBest == null)
            {
                ...
                throw GetErrorContext().Error(Microsoft.CSharp.RuntimeBinder.Errors.ErrorCode.ERR_AmbigCall, pmethAmbig1.mpwi, pmethAmbig2.mpwi);
            }
