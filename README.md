...
`master` branch can build against `EFT 0.12.11.15680` (tested with `spt-aki Version 2.1.2`). If you are looking for another version, see [`branches`](https://github.com/sailro/EscapeFromTarkov-Trainer/branches) and [`releases`](https://github.com/sailro/EscapeFromTarkov-Trainer/releases).
