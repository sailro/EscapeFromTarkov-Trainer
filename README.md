...
`master` branch can build against `EFT 0.12.11.14290` (tested with `spt-aki Version 2.0.1`). If you are looking for another version, see [`branches`](https://github.com/sailro/EscapeFromTarkov-Trainer/branches) and [`releases`](https://github.com/sailro/EscapeFromTarkov-Trainer/releases).
